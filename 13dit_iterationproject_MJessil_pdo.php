...
try {
	$conn = new PDO('mysql:host=localhost;dbname=MJessil_13dit_iterationproject_MJessil', '_MJessil', 'WZu6LCtKnpfdpjT5');
	...
	die("Error Connecting to Database: MJessil_13dit_iterationproject_MJessil");
}
?>